const albums = [
  ...
  { title: 'Born to Run', genre: 'Rock', duration: 50.11 },
...
for (let i = 0; i < albums.length; i++) {
    if (albums[i].genre === 'Rock') {
        duracionTotalRock += albums[i].duration;
    }
}

console.log(`La duración total de los álbumes de género "Rock" es de ${duracionTotalRock.toFixed(2)} minutos.`);
